    ...
    <div className="flex flex-col h-full">
      ...
      <div className="bg-white border-b border-[#E5E7EB] px-5 py-3 shrink-0 flex flex-wrap items-center justify-between gap-3">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <h1 className="text-[15px] font-bold text-[#16171D] leading-tight">Divisão de Conta — {tituloRef}</h1>
        ...
        <div className="flex items-center gap-2">
          ...
          <select
            ...
            className="text-xs rounded-lg px-3 py-2 text-[#5B5D69] bg-[#F6F5F2] border border-[#E7E5DF] focus:outline-none focus:border-[#01B8FA]/50 disabled:opacity-50 max-w-[220px]"
          >
      ...
      <div className="flex-1 overflow-auto p-5">
        {!filialId ? (
          <div className="text-center py-16 text-[#A0A2AD] text-sm">Selecione uma filial para dividir contas.</div>
        ) : carregando ? (
          ...
          <div className="text-center py-16 text-[#A0A2AD] text-sm">Nenhuma comanda aberta para dividir.</div>
        ) : (
          <div className="max-w-5xl mx-auto grid gap-5 lg:grid-cols-[1.3fr_1fr]">
            ...
            <div>
              ...
              <div className="rounded-2xl border border-[#E7E5DF] bg-white overflow-hidden">
                {itens.length === 0 && (
                  <div className="px-4 py-8 text-center text-[11px] text-[#A0A2AD]">Esta comanda ainda não tem itens.</div>
                )}
                {itens.map((i) => (
                          ...
                          return (
                            <button
                              ...
                              className={`flex items-center gap-1 text-[11px] font-semibold px-2 py-1 rounded-full border transition-all ${
                                sel2 ? 'text-white border-transparent' : 'text-[#8B8D98] border-[#E7E5DF] hover:border-[#01B8FA]/40'
                              }`}
            ...
            <div>
              ...
              {/* Forma de pagamento */}
              <h2 className="text-xs font-bold uppercase tracking-wide text-[#8B8D98] mt-4 mb-2">Forma de pagamento</h2>
                  ...
                  return (
                    <button
                      ...
                      className={`flex flex-col items-center gap-1 py-2.5 rounded-xl border text-xs font-semibold transition-all ${
                        ativo
                          ? 'bg-[#01B8FA]/[0.10] border-[#01B8FA]/45 text-[#0678a0]'
              ...
              <p className="text-[10px] text-[#A0A2AD] text-center mt-2">
